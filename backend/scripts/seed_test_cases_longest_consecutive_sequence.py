"""
Seed script for test cases for the "Longest Consecutive Sequence" problem.

Run from backend/:
    source venv/bin/activate
    python scripts/seed_test_cases_longest_consecutive_sequence.py
"""
...
TARGET_PROBLEM_SLUG = "longest-consecutive-sequence"
TARGET_PROBLEM_TITLE = "Longest Consecutive Sequence"

LONGEST_CONSECUTIVE_TEST_CASES = [
    {
        "params": {"nums": [100, 4, 200, 1, 3, 2]},
        "expected_output": 4,
        "is_hidden": False,
    },
    {
        "params": {"nums": [0, 3, 7, 2, 5, 8, 4, 6, 0, 1]},
        "expected_output": 9,
        "is_hidden": False,
    },
    {
    ...
    {
        "params": {"nums": [10, 30, -5, -4, -3, -2, -1]},
        "expected_output": 5,
        "is_hidden": False,
    },
    {
        "params": {"nums": list(range(5000))},
        "expected_output": 5000,
        "is_hidden": True,
    },
    {
        "params": {"nums": list(range(-2500, 2500, 2))},
        "expected_output": 1,
        "is_hidden": True,
    },
    {
        "params": {"nums": [9, 1, 4, 7, 3, -1, 0, 5, 8, -1, 6]},
        "expected_output": 7,
        "is_hidden": False,
    },
    {
    ...
    {
        "params": {"nums": [50, 51, 52, 10, 11, 12, 13, -2, -1, 0, 1]},
        "expected_output": 5,
        "is_hidden": False,
    },
    {
        "params": {"nums": [1000000000, 999999999, 999999998, -1000000000]},
        "expected_output": 3,
        "is_hidden": True,
    },
]
...
def seed_longest_consecutive_test_cases() -> None:
    ...
    try:
        ...
        if problem is None:
            raise RuntimeError(
                "Longest Consecutive Sequence problem not found. Seed it first via scripts/seed_problem_longest_consecutive_sequence.py"
            )
        ...
        seed_params_keys = {_params_key(tc["params"]) for tc in LONGEST_CONSECUTIVE_TEST_CASES}
        ...
        for seed_case in LONGEST_CONSECUTIVE_TEST_CASES:
...
if __name__ == "__main__":
    seed_longest_consecutive_test_cases()
